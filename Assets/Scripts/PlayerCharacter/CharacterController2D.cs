// This script is from "2D Movement in Unity (Tutorial)" by Brackeys 
// https://www.youtube.com/watch?v=dwcT-Dch0bA&ab_channel=Brackeys
// Comments are written by Brackeys

// I heavily modified the code as I didn't need it Crouch function; see Development Diary for more details
...
public class CharacterController2D : MonoBehaviour
{
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (m_Grounded && jump)
		{
			...
			aud.Play(); // to play the Jump audio
		}
	}
